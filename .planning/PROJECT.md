...
## Current Milestone: v1.0 Mirror Makeup MVP

**Goal:** 三個 phase 全部完成，Vercel 部署上線，面試 demo 可用

**Target features:**
- Foundation：Next.js 14 + Vercel Postgres + seed data + FAL.ai API proxy
- Core Generation Flow：試妝選擇 UI + 生成 pipeline + 輪詢 + DB 記錄
- Display & Polish：Before/After slider + Showcase 頁 + Vercel 部署
